      ...
      <main>
        <div className="flex flex-wrap justify-between w-sreen">
          ...
          <div className=" flex position-start w-full">
            <img
              src="/Mypic.jpeg"
              className="bg-white blur-2xl w-1/3 ml-44 -mt-20 "
              alt="my Pic"
            />
            <div className="  w-2/3">
              ...
              <div className="h-2/3 w-auto">
                ...
                <h1 className="text-white pr-20">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                  Optio quasi fugit nemo enim culpa, maxime asperiores
                  reprehenderit aliquam obcaecati et voluptatum nisi placeat
                  labore debitis libero. Debitis suscipit exercitationem Lorem
                  ipsum dolor sit, amet consectetur adipisicing elit. Voluptatem
                  voluptate placeat minus aut, consequuntur rem! Nisi adipisci
                  molestias minima illo optio, expedita, sunt at amet
                  reprehenderit, qui officiis ducimus nesciunt.
                </h1>

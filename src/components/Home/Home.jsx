            ...
            <div className="  w-2/3">
              ...
              <div className="h-2/3 w-auto">
                ...
                <h1 className="text-black dark:text-white font-serif text-sm pr-20">
                  ...
                  more. With a solid foundation in Git, I'm adept at version
                  control, ensuring smooth collaboration on projects. I have
                  hands-on experience with popular frameworks like Tailwind CSS
                  and Bootstrap, bringing creativity and responsiveness to my
                  web development projects. My proficiency extends to database
                  management, with knowledge in MySQL and SQLite. As a
                  developer, I thrive in the world of IDEs, from PyCharm to
                  Visual Studio Code, ensuring an efficient and enjoyable coding
                  experience. Whether it's crafting backend logic with Flask or
                  creating visually appealing frontends, 🚀
                </h1>

                <span className="flex items-end justify-end">
                  <a
                    href="https://drive.google.com/file/d/1-0lufqqaaBwESyopRIdytTm5Sy0Z3S_O/view"
                    target="_blank"
